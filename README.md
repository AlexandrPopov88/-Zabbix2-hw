# Домашнее задание к занятию "`Система мониторинга Zabbix. Часть 2`" - `Попов Александр`
...
- [ ] Прикрепите в файл README.md скриншот страницы шаблона с названием «Задание 1»
 ---
 ![задание1](https://github.com/user-attachments/assets/a89e2809-d479-493c-9835-0287ab3f33cd)
...
- [ ] Прикрепите в файл README.md скриншот страницы хостов, где будут видны привязки шаблонов с названиями «Задание 2-3». Хосты должны иметь зелёный статус подключения
 ---
 ![zadan3](https://github.com/user-attachments/assets/f8600cc4-6276-400a-828c-44f5beb7ae22)
...
- [ ] Прикрепите в файл README.md скриншот дашборда с названием «Задание 4»
 ...
 ---
 ![задание4](https://github.com/user-attachments/assets/c9a0269a-6c96-4944-ade8-b5f2d70ec62e)
